...
public class AddComentViewModel extends AndroidViewModel {
    public AddComentViewModel(@NonNull Application application) {
        super(application);
    }
    /**
     ...
     */
    public LiveData<Boolean> addComent(int id, String contentComent){
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                 ...
                 */
                Boolean b = inNatureRepository.addComent(id,contentComent);
