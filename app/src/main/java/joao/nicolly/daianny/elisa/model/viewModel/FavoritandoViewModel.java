...
public class FavoritandoViewModel extends AndroidViewModel {
    public FavoritandoViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public LiveData<Boolean> favoritandoPlanta(int id){
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                 ...
                 */
                Boolean b = inNatureRepository.favoritarPlanta(id);
