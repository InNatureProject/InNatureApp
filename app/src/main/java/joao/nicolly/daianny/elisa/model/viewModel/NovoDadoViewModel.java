...
public class NovoDadoViewModel extends AndroidViewModel {
    public NovoDadoViewModel(@NonNull Application application) {
        super(application);
    }
    public LiveData<Boolean> setNewImageUser(String dado, String qualDado){
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                 ...
                 */
//                Boolean b = inNatureRepository.setImageUser(dado,qualDado);
