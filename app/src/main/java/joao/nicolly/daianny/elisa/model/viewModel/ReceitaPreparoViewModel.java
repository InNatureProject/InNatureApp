    ...
    public LiveData<ReceitaPreparo> getReceita(int idPlanta, int idTipoPreparo){
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                // O método loadReceita obtem os dados detalhados de uma receita junto ao servidor.
                // Ele retorna um objeto do tipo ReceitaPreparo, que contém os dados detalhados da receita.
